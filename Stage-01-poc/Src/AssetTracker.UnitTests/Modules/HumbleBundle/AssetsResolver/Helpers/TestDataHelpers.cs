...
namespace AssetTracker.UnitTests.Modules.HumbleBundle.AssetsResolver.Helpers
{
    internal static class TestDataHelpers
    {
        public static string LoadTestHtml(string fileName)
        {
            ...
            var resourceName = $"AssetTracker.UnitTest.Modules.HumbleBundle.AssetsResolver.TestData.{fileName}";
