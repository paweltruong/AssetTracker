...
{
    public class DefaultHttpClientAssetsImporterMasterModel : IScraperServiceMasterModel
    {
        ...
        public DefaultHttpClientAssetsImporterMasterModel(IServiceProvider serviceProvider, IAssetsImporterPlugin plugin)
        {
            ...
            var importAssetsViewModel = factory.CreateDefaultHttpClientAssetsImporterViewModel(plugin);   
            var importAssetsView = serviceProvider.GetRequiredService<DefaultHttpClientAssetsImporterView>();
